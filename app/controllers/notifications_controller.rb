class NotificationsController < ApplicationController
  ...
  def delete_all
  	Notification.delete(params[:notification_ids])
		logger.debug "delete_all called with params: " + params.to_yaml
		# rjs to remove items
		render :nothing => true
  end
  ...
  def delete_selected
  	Notification.delete(params[:notification_ids])
		logger.debug "delete_selected called with params: " + params.to_yaml
		# rjs to remove items
		render :nothing => true
  end
