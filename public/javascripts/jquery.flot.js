...
(function($) {
    function Plot(target_, data_, options_) {
        ...
        var series = [],
            ...
            colors: ["#8fcd37", "#999999", "#4cc4e4", "#bcbdc0", "#9440ed"],
                legend: {
                    show: true,
                    ...
                    margin: -100, // distance from grid edge to default legend container within plot
                ...
                points: {
                    ...
                    fill: false,
                    fillColor: "rgba(161,161,161,0.8)"
                },
                lines: {
                    show: false,
                ...
                bars: {
                    ...
                    barWidth: 1.7, // in units of the x axis
                    fill: .7,
                    fillColor: null,
                ...
                grid: {
                    ...
                    tickColor: "#ecf8fe", // color used for the ticks
                    labelMargin: 5, // in pixels
                    borderWidth: 0,
                    markings: null, // array of ranges or fn: axes -> array of ranges
                    markingsColor: "#f9f8f8",
                    markingsLineWidth: 2,
                    // interactive stuff
                    clickable: false,
                    hoverable: false,
        ...
        function insertLegend() {
            ...
            for (i = 0; i < series.length; ++i) {
                ...
                fragments.push(
                    '<td class="legendColorBox"><div style=" ' + options.legend.labelBoxBorderColor + ';padding:1px"><div class="color-box" style="background-color:' + series[i].color + ';overflow:hidden"></div></div></td>' +
            ...
            if (options.legend.container != null)
                ...
                var legend = $('<div class="legend">' + table.replace() + '</div>').appendTo(target);
